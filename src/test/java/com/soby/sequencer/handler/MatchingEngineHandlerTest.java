...
/**
 * Unit tests for MatchingEngineHandler. Tests the matching logic in isolation without the
 * Disruptor.
 */
public class MatchingEngineHandlerTest {
  ...
  public void testNoMatchWhenSpreadNotCrossed() {
    // Test 2: publish a BUY LIMIT at 99 and a SELL LIMIT at 100 - assert no match (spread not
    // crossed)
