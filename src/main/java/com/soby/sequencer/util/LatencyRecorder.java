...
/**
 * Wraps HdrHistogram for recording and reporting nanosecond-resolution latencies.
 * Thread-safe via SynchronizedHistogram. Used by each handler stage to measure
 * its contribution to total pipeline latency.
 */
